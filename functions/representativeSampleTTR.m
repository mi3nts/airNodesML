function [In_Train,Out_Train,...
               ...
               trainingTT, validatingTT,...
                ...
                trainingTT_Testing , validatingTT_Testing ,...
                    trainingT_Testing , validatingT_Testing ...
                            ...
                            = representativeSampleTTR(timeTableIn,inputVariables,target,pvalid,nbins_per_column,n_per_bin,...
                            testingVariables)
    ...
    InTesting              =  table2array(tableIn(:,testingVariables));
    
    Out_Train_Testing  =  Out_Train;
    Out_Validation_Testing = Out_Validation;
    In_Train_Testing       = InTesting(ikeepAllTraining,:);
    In_Validation_Testing  = InTesting(ikeepAllValidating,:);
    
    trainingTT_Testing       = timeTableIn(ikeepAllTraining ,{testingVariables{:},target});
    validatingTT_Testing     = timeTableIn(ikeepAllValidating,{testingVariables{:},target});

    trainingT_Testing             = timetable2table(trainingTT_Testing);
    validatingT_Testing           = timetable2table(validatingTT_Testing);
    
    trainingT_Testing.dateTime   = [];
    validatingT_Testing.dateTime = [];  
