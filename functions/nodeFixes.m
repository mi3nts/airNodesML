...
function mintsDataUTD = nodeFixes(nodeID,mintsDataUTD,rawMatsFolder)
...
if nodeID == "001e06318c91"
    ...
    mintsData_001e06318c91.GPSGPGGA2_altitude(...
        mintsData_001e06318c91.dateTime<datetime(2020,12,5,'timezone','utc')&...
        mintsData_001e06318c91.dateTime>datetime(2019,5,24,'timezone','utc'),:)=222.2;
    ...
    mintsData_001e06318c91.GPSGPGGA2_altitude(...
        mintsData_001e06318c91.dateTime<datetime(2021,2,23,'timezone','utc')&...
        mintsData_001e06318c91.dateTime>datetime(2021,2,3,'timezone','utc'),:)=222.2;
    ...
    mintsData_001e06318c91.GPSGPGGA2_altitude(...
        mintsData_001e06318c91.dateTime<datetime(2021,4,15,'timezone','utc')&...
        mintsData_001e06318c91.dateTime>datetime(2021,3,4,'timezone','utc'),:)=222.2;
    ...
    mintsData_001e0637371e.GPSGPGGA2_altitude(...
        mintsData_001e0637371e.dateTime<datetime(2020,9,28,'timezone','utc')&...
        mintsData_001e0637371e.dateTime>datetime(2020,8,14,'timezone','utc'),:)=222.2;
    ...
    mintsData_001e0637371e.GPSGPGGA2_altitude(...
        mintsData_001e0637371e.dateTime<datetime(2020,10,26,13,20,00,'timezone','utc')&...
        mintsData_001e0637371e.dateTime>datetime(2020,10,03,00,30,00,'timezone','utc'),:)=222.2;
    ...
    mintsData_001e0637371e.GPSGPGGA2_altitude(...
        mintsData_001e0637371e.dateTime<datetime(2021,08,04,'timezone','utc')&...
        mintsData_001e0637371e.dateTime>datetime(2020,11,07,21,30,00,'timezone','utc'),:)=222.2;
...
if nodeID  == "001e06323a06"
    mintsDataUTD(mintsDataUTD.dateTime<...
        datetime(2020,10,21,'timeZone','utc'),:) = [] ;
end
