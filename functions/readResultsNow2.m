function [bestModels,bestModelsLabels]  = readResultsNow2(fileName,nodeID,mintsTargets,modelsFolder)
    ...
    for n = 1 : length(mintsTargets)
        ...
        if(height(targetResults)>10)
            targetResults = targetResults(end-9:end,:);
        end     
