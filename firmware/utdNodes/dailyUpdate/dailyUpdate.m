...
% Global Bounds 
inCorrected = checkBoundsDaily(inCorrected,nodeID,versionStrDaily,modelsFolder,"completeBounds");
% Training Bounds 
...
preFigName  =  strcat(updateFolder,"/",nodeID,"/", ...
    num2str(year(dataDate),'%04d'),"/",...
    num2str(month(dataDate),'%02d'),"/",...
    num2str(day(dataDate),'%02d'),"/MINTS_",nodeID,"_",...
    num2str(year(dataDate),'%04d'),"_",...
    num2str(month(dataDate),'%02d'),"_",...
    num2str(day(dataDate),'%02d'))
