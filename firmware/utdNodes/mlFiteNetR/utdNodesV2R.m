function [] = utdNodesV2R(nodeIndex)
% # ***************************************************************************
% #   ---------------------------------
...
% #  Unlike V2 Uses Real Temperatures 
...
eval(strcat("pmAppendsReal        = mintsDefinitions.pmAppendsReal_",string(nodeIDs{nodeIndex}.pmStack),";"));
...
pmInputsTesting       = [pmInputsCorrected,pmAppendsCalib]; 
...
pmInputsCombined       = [pmInputsCorrected,pmAppendsReal]; 
pmInputsLabelsCombined = [pmInputLabels,climateInputLabels];


combined.temperatureCalib = polyval(temperatureParams,combined.BME280_temperatureK) ;
combined.pressureCalib    = polyval(pressureParams   ,combined.BME280_pressureLog) ;
combined.humidityCalib    = polyval(temperatureParams,combined.BME280_humidity) ;
