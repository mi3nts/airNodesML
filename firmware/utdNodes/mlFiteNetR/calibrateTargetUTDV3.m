function Mdl= calibrateTargetUTDV3(...
...
display("Training")
Mdl  = fitRNetOptimized(In_Train,Out_Train,minLayers,maxLayers,MaxEvaluations);
display("Trained")
...
resultsCurrent.minLayers          = minLayers;
resultsCurrent.maxLayers          = maxLayers ;
resultsCurrent.MaxEvaluations     = MaxEvaluations;
