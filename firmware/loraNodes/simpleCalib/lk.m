...
% In = rmmissing(mintsDataUTD(:,pmInputs(1:5)));
% Out= rmmissing(mintsDataUTD(:,pmInputs(1:5)));

utdWithPalas  = rmmissing(synchronize(mintsDataUTD,palasWSTC,'intersection'));

In = table2array(utdWithPalas(:,pmInputs(1:5)))';
Out= table2array(utdWithPalas(:,['pm1_palas']))';
...
% Out  = Out(:,1:800);
% 
% X = tonndata(In,true,false);
% T = tonndata(Out,true,false);
% 
% 
