function [] = utdNodesExample(nodeIndex)
% # ***************************************************************************
% #   ---------------------------------
...
display("Start Date: " +  string(utdMints.dateTime(1)))
display("End Date:  "  +  string(utdMints.dateTime(end)))
display("Data Length: "+  string(height(utdMints)))
